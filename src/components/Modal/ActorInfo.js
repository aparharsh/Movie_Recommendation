       ...
       <div>
          ...
          <div className="AIAbout">
            ...
            <div className="AILeftPopular">
              Popular Movies : 
              <span onClick={ (m) => this.props.ThMod(this.props.data.known_for[0])}>   { this.props.data.known_for[0]} &nbsp; </span>
              <span onClick={ (m) => this.props.ThMod(this.props.data.known_for[1])}> |&nbsp; { this.props.data.known_for[1]} &nbsp; </span>
              <span onClick={ (m) => this.props.ThMod(this.props.data.known_for[2])}> |&nbsp; { this.props.data.known_for[2]} &nbsp; </span>
              <span onClick={ (m) => this.props.ThMod(this.props.data.known_for[3])}> |&nbsp; { this.props.data.known_for[3]} &nbsp; </span>
            </div>
